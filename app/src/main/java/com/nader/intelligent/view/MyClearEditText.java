...
public class MyClearEditText extends AppCompatEditText {
    ...
    public MyClearEditText(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyClearEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
